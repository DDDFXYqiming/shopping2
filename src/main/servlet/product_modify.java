...
public class product_modify extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("修改商品id"+productId);
...
//        product_in.setPRODUCT_STOCK(productStock);
        ...
        pr_dao.update_by_id(productId, productName, productDescription, productPrice, productStock);
